...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::prefix('course-management')->group(function () {
        ...
        Route::prefix('lesson')->group(function () {
            ...
            Route::post('delete-media-resource', [LessonController::class, 'deleteLessonMediaResource'])->name('admin.course.management.lesson.delete.media.resource'); //delete video and pdf resources
            Route::post('delete-article-resource', [LessonController::class, 'deleteLessonArticleResource'])->name('admin.course.management.lesson.delete.article.resource'); //delete article resources
