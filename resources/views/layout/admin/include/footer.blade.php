<footer class="footer">
    <div class="container-fluid clearfix">
        <span class="text-muted d-block text-center text-sm-left d-sm-inline-block">Copyright © abhithsiksha.com
            2021 - <?php echo date('Y'); ?>.</span>
        <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> <a
                href="https://www.ekodus.com" target="_blank">Design with  
            ...
            by</a> <span style="color:#D16226;">Ekodus Inc.</span> </span>
    </div>
</footer>
